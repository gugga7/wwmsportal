      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'Main_EventsDrafts',
              path: 'mainEventsDrafts',
              requireAuth: true,
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'Main_EventsDrafts')
                  : NavBarPage(
                      initialPage: 'Main_EventsDrafts',
                      page: MainEventsDraftsWidget(),
                    ),
            ),
            FFRoute(
              ...
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'Main_customerListCopy')
                  : MainCustomerListCopyWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              name: 'projectDetailsHealthAiCopy',
              path: 'projectDetailsHealthAiCopy',
              builder: (context, params) => ProjectDetailsHealthAiCopyWidget(),
            ),
            FFRoute(
