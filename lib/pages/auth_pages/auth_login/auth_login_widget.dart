                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'egywwhia' /* Use the form below to access y... */,
                                    ),
                                    style:
                                        ...
                                        child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                            ...
                                            hintText:
                                                FFLocalizations.of(context)
                                                    .getText(
                                              's72j97zt' /* Enter your email here... */,
                                            ),
                                            hintStyle:
                                                FlutterFlowTheme.of(context)
                                                    .labelMedium,
                                        ...
                                        child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                            ...
                                            hintText:
                                                FFLocalizations.of(context)
                                                    .getText(
                                              'dxqryvbp' /* Enter your password here... */,
                                            ),
                                            hintStyle:
                                                FlutterFlowTheme.of(context)
                                                    .labelMedium,
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      AutoSizeText(
                                        FFLocalizations.of(context).getText(
                                          'nzd7m0ds' /* Use a social platform to conti... */,
                                        ),
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          '9majnim1' /* Don't have an account? */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .labelMedium,
                                      ),
