                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '2vw14nbl' /* Use the form below to get star... */,
                                ),
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        labelText:
                                            FFLocalizations.of(context).getText(
                                          'eviqvf45' /* Email Address */,
                                        ),
                                        labelStyle: FlutterFlowTheme.of(context)
                                            .labelMedium,
                                        hintText:
                                            FFLocalizations.of(context).getText(
                                          '1s2lc5fx' /* Enter your email here... */,
                                        ),
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText:
                                        FFLocalizations.of(context).getText(
                                      '1j2rn4he' /* Confirm Password */,
                                    ),
                                    labelStyle: FlutterFlowTheme.of(context)
                                        .labelMedium,
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      'rqfxj8hf' /* Create your password... */,
                                    ),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .labelMedium,
                                    enabledBorder: OutlineInputBorder(
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  AutoSizeText(
                                    FFLocalizations.of(context).getText(
                                      '5ho8l35w' /* Use a social platform to conti... */,
                                    ),
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      '35xip7ss' /* Already have an account? */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium,
                                  ),
