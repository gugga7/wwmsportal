...
import 'project_details_health_ai_copy_model.dart';
export 'project_details_health_ai_copy_model.dart';

class ProjectDetailsHealthAiCopyWidget extends StatefulWidget {
  const ProjectDetailsHealthAiCopyWidget({Key? key}) : super(key: key);

  @override
  _ProjectDetailsHealthAiCopyWidgetState createState() =>
      _ProjectDetailsHealthAiCopyWidgetState();
}

class _ProjectDetailsHealthAiCopyWidgetState
    extends State<ProjectDetailsHealthAiCopyWidget>
    with TickerProviderStateMixin {
  late ProjectDetailsHealthAiCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProjectDetailsHealthAiCopyModel());
  ...
  Widget build(BuildContext context) {
    return Title(
        title: 'projectDetailsHealthAiCopy',
                                    ...
                                    children: [
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'sllramc9' /* Company Meeting Event */,
                                        ),
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            'd3xraolk' /* Client Acquisition for Q3 */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .labelMedium,
                                        ).animateOnPageLoad(animationsMap[
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      '1vws3d3g' /* Additional Details around this... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium,
                                  ),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'wv27a5f4' /* Additional Details around this... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium,
                                  ),
