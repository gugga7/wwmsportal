              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'j6ljc21o' /* Below are your profile details */,
                      ),
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: SelectionArea(
                                        child: Text(
                                      FFLocalizations.of(context).getText(
                                        'j2n18vc0' /* The email associated with this... */,
                                      ),
                                  ...
                                  Padding(
                                    ...
                                    child: SelectionArea(
                                        child: Text(
                                      FFLocalizations.of(context).getText(
                                        'ur83kxyc' /* casper@ghostbusters.com */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyLarge,
                                    )),
